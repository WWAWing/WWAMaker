...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wwamk_parts__ = __webpack_require__(4);
...
var WWAMk = (function () {
    ...
    WWAMk.prototype.setData = function (data) {
        ...
        for (var i = 0; i < this._wwamkData.objectPartsMax; i++) {
             ...
             */
            this._wwamkData.objectParts[i] = new __WEBPACK_IMPORTED_MODULE_1__wwamk_parts__["c" /* ObjectParts */]();
        }
        var i = 0;
        this._wwamkData.objectParts.forEach(function (parts) {
            ...
            if (data["objectAttribute"][i] === undefined) {
                ...
                for (var j = 0; j < 10; j++) {
                    parts.appearParts[j] = new __WEBPACK_IMPORTED_MODULE_1__wwamk_parts__["a" /* AppearParts */](data["objectAttribute"][i][PARTS_ATTRIBUTE_START_APPEAR + (j * 4)], // パーツ番号
        ...
        for (var i = 0; i < this._wwamkData.mapPartsMax; i++) {
            this._wwamkData.mapParts[i] = new __WEBPACK_IMPORTED_MODULE_1__wwamk_parts__["b" /* MapParts */]();
        }
        var i = 0;
        this._wwamkData.mapParts.forEach(function (parts) {
            if (data["mapAttribute"][i] === undefined) {
                ...
                for (var j = 0; j < 10; j++) {
                    parts.appearParts[j] = new __WEBPACK_IMPORTED_MODULE_1__wwamk_parts__["a" /* AppearParts */](data["mapAttribute"][i][PARTS_ATTRIBUTE_START_APPEAR + (j * 4)], data["mapAttribute"][i][PARTS_ATTRIBUTE_START_APPEAR + (j * 4) + 3], data["mapAttribute"][i][PARTS_ATTRIBUTE_START_APPEAR + (j * 4) + 1], data["mapAttribute"][i][PARTS_ATTRIBUTE_START_APPEAR + (j * 4) + 2]);
                } // for
            } // else
            i++;
        });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return ObjectParts; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return MapParts; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AppearParts; });
